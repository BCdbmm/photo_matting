...
parser.add_argument('--decay_epochs', default=5, type=int,
...
parser.add_argument('--model_dir', default='../saves', type=str,
...
def train():
    ...
    # test_img = _transform(
    #     PIL.Image.open('/home/disk1/datas/photo_matting/clip_img/1803151818/clip_00000019/1803151818-00019731.jpg'))
    # test_trimap = torch.Tensor(
    #     np.array(PIL.Image.open('/home/disk1/datas/photo_matting/trimaps/1803151818-00019731.png')) / 255.).unsqueeze(0)
    # test_input = torch.cat((test_img,test_trimap),0).unsqueeze(0)
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        ls=0
        for i, (_,images, alphas, alphas_noise, masks) in enumerate(train_loader):
            ...
            loss=model.loss(outputs,alphas)
